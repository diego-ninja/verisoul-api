...
describe('Client Integration Tests', function (): void {
    ...
    describe('Account Client Integration', function (): void {
        it('performs complete account lifecycle with real HTTP flow', function (): void {
    ...
    describe('Session Client Integration', function (): void {
        it('performs complete session authentication flow', function (): void {
            $mockHttpClient = MockFactory::createSuccessfulHttpClient([
        ...
        it('handles session state transitions correctly', function (): void {
            $stateTransitions = [
    ...
    describe('Cross-Client Integration', function (): void {
        it('maintains consistent state across multiple client instances', function (): void {
        ...
        it('handles environment switching consistently across clients', function (): void {
            ...
            $mockHttpClient->shouldReceive('get')
                ->once()
                ->withArgs(fn($url) => str_contains($url, 'sandbox.verisoul.ai'))
    ...
    describe('Error Recovery Integration', function (): void {
        it('recovers from network failures using retry strategy', function (): void {
        ...
        it('handles cascading failures across multiple operations', function (): void {
