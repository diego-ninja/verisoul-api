...
describe('ListClient', function () {
    describe('construction', function () {
        ...
        it('implements ListInterface', function () {
            $client = new ListClient('test_api_key');
    ...
    describe('createList method', function () {
        it('creates ListOperationResponse object', function () {
        ...
        it('passes list name and description correctly', function () {
            ...
            $mockHttpClient->shouldReceive('post')
                ->once()
                ->withArgs(function ($url, $data) use ($listName, $description) {
                    return str_contains($url, "/list/{$listName}") &&
        ...
        it('handles various list names and descriptions', function () {
            $listScenarios = [
    ...
    describe('getAllLists method', function () {
        it('creates AccountListCollection object', function () {
            $mockHttpClient = MockFactory::createSuccessfulHttpClient([
                'get' => [
                    'lists' => [
                        [
        ...
        it('handles empty lists response', function () {
            $mockHttpClient = MockFactory::createSuccessfulHttpClient([
                'get' => ['lists' => []]
            ]);
        ...
        it('handles multiple lists with various account counts', function () {
            $listsData = [
                'lists' => [
                    [
                        'name' => 'small_list',
    ...
    describe('getList method', function () {
        it('creates AccountList object', function () {
            $mockHttpClient = MockFactory::createSuccessfulHttpClient([
                'get' => [
                    'name' => 'test_list',
        ...
        it('constructs correct URL with list name', function () {
            ...
            $mockHttpClient->shouldReceive('get')
                ->once()
                ->withArgs(function ($url, $params) use ($listName) {
                    return str_contains($url, "/list/{$listName}");
                })
                ->andReturn([
                    'name' => $listName,
        ...
        it('handles various list names', function () {
            $listNames = [
                'whitelist',
                'blacklist',
                'vip-customers',
    ...
    describe('addAccountToList method', function () {
        it('creates ListOperationResponse object', function () {
            $mockHttpClient = MockFactory::createSuccessfulHttpClient([
                'post' => [
                    'list_name' => 'test_list',
        ...
        it('passes list name and account ID correctly', function () {
            $listName = 'fraud_list';
            ...
            $mockHttpClient->shouldReceive('post')
                ->once()
                ->withArgs(function ($url, $data) use ($listName, $accountId) {
                    return str_contains($url, "/list/{$listName}/account/{$accountId}");
                })
                ->andReturn([
                    'list_name' => $listName,
        ...
        it('handles bulk account additions', function () {
    ...
    describe('deleteList method', function () {
        it('creates ListOperationResponse object', function () {
            $mockHttpClient = MockFactory::createSuccessfulHttpClient([
                'delete' => [
                    'list_name' => 'test_list',
        ...
        it('constructs correct DELETE URL', function () {
            ...
            $mockHttpClient->shouldReceive('delete')
                ->once()
                ->withArgs(function ($url, $data) use ($listName) {
                    return str_contains($url, "/list/{$listName}");
                })
                ->andReturn([
                    'list_name' => $listName,
        ...
        it('handles various list names for deletion', function () {
            $listNames = [
                'old_whitelist',
    ...
    describe('removeAccountFromList method', function () {
        it('creates ListOperationResponse object', function () {
            $mockHttpClient = MockFactory::createSuccessfulHttpClient([
                'delete' => [
                    'list_name' => 'test_list',
        ...
        it('constructs correct URL with list name and account ID', function () {
        ...
        it('handles bulk account removals', function () {
    ...
    describe('real-world usage scenarios', function () {
        it('handles complete list management workflow', function () {
            // Create list
            $createResponse = [
        ...
        it('handles fraud investigation list workflow', function () {
        ...
        it('handles VIP customer list management', function () {
            // Get all lists first
            $allListsResponse = [
                'lists' => [
                    [
        ...
        it('handles list cleanup and migration workflow', function () {
    ...
    describe('parameter validation scenarios', function () {
        it('handles various list name formats', function () {
            $listNames = [
                'simple_list',
                'list-with-hyphens',
                'ListWithCamelCase',
        ...
        it('handles various account ID formats', function () {
            $accountIds = [
                'simple_account',
        ...
        it('handles complex list descriptions', function () {
            $complexDescriptions = [
                'Simple description',
