...
describe('Score Value Object', function (): void {
    describe('construction', function (): void {
        it('can be created with valid float value', function (): void {
        ...
        it('can be created with integer value', function (): void {
            $score = new Score(1);
        ...
        it('accepts minimum valid value (0.0)', function (): void {
            $score = new Score(0.0);

            expect($score->value)->toBe(0.0);
        });

        it('accepts maximum valid value (1.0)', function (): void {
            $score = new Score(1.0);

            expect($score->value)->toBe(1.0);
        });

        test('valid scores from data provider', function (float $value): void {
    ...
    describe('validation', function (): void {
        it('validates against rules', function (): void {
            $rules = Score::rules();
        ...
        it('validates scores should be between 0 and 1', function (): void {
        ...
        it('handles edge values', function (): void {
    ...
    describe('factory methods', function (): void {
        it('can be created from float using from()', function (): void {
        ...
        it('can be created from integer using from()', function (): void {
            $score = Score::from(1);
        ...
        it('can be created from array with value key', function (): void {
        ...
        it('returns same instance when passed Score object', function (): void {
        ...
        it('handles edge case values correctly', function (): void {
    ...
    describe('immutability', function (): void {
        ...
        it('preserves value through operations', function (): void {
            $score = new Score(0.75);
            $value1 = $score->value();
            $value2 = $score->value;
            $value3 = $score->value();
    ...
    describe('string conversion', function (): void {
        ...
        it('handles different precision levels', function (): void {
    ...
    describe('equality and comparison', function (): void {
        it('compares equal scores correctly', function (): void {
    ...
    describe('object creation patterns', function (): void {
        it('can be created from various inputs', function (): void {
        ...
        it('handles different factory patterns', function (): void {
    ...
    describe('performance and edge cases', function (): void {
        it('handles very precise decimal values', function (): void {
        ...
        it('handles boundary values correctly', function (): void {
            $minScore = new Score(0.0);
            $maxScore = new Score(1.0);
        ...
        it('works with typical confidence score values', function (): void {
...
describe('Score integration with Pest expectations', function (): void {
    it('works with custom toBeValidScore expectation', function (): void {
        $score = new Score(0.75);

        expect($score)->toBeValidScore();
    });

    it('can be used in complex assertions', function (): void {
        $scores = [
            new Score(0.95),
            new Score(0.85),
            new Score(0.75),
